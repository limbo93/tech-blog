    ...
    <main className="bg-gray-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to TechBlog.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to TechBlog, accessible from <a href="https://atechblog.vercel.app" rel="external nofollow noopener" target="_blank">https://atechblog.vercel.app</a>
          </li>
          <li>
        ...
        <ul>
          <li><div className="font-bold">Cookies or Browser Cookies: </div> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that it will refuse Cookies, our Service may use Cookies.</li>
          <li><div className="font-bold">Web Beacons: </div> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).</li>
        </ul>
        ...
        <h3 className="font-bold mb-2">Use of Your Personal Data</h3>
        ...
        <h3 className="font-bold mb-2">Retention of Your Personal Data</h3>
        ...
        <p className="mb-4">We will let You know via a prominent notice on Our Service, prior to the change becoming effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</p>
        ...
        <ul>
          <li>By email: mhriad0@gmail.com</li>
        </ul>
      </div>
    </main>
  );
